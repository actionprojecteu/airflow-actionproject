...
class FoliumMapOperator(BaseOperator):
    ...
    @apply_defaults
    def __init__(self, input_path, output_path, ssh_conn_id, imag_remote_slug, meta_remote_slug, center_latitude, center_longitude, zoom_start=6, max_zoom=19, **kwargs):
        super().__init__(**kwargs)
        self._ssh_conn_id = ssh_conn_id
        self._img_remote_slug = imag_remote_slug
        self._meta_remote_slug = meta_remote_slug
        self._input_path = input_path
        self._output_path = output_path
        self._context = {}
